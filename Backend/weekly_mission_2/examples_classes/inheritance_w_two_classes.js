...
const baruchLaunchXDev = new LaunchXStudent('Baruch Guerra', 'JavaScript', ['Mongo', 'React', 'Node', 'Express']);
console.log(baruchLaunchXDev);
console.log(baruchLaunchXDev.getName);