...
console.log('Estudiantes modificados por setter: ', missionCommanderNode.getStudents);// 0 por default
console.log(`Vidas modificadas por setter: ${missionCommanderNode.getLives}`);// 0 por default
